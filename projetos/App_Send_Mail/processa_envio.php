<?php 
	...
	try {
			...
			$mail->Username   = 'lucascarregal123@gmail.com';                     //SMTP username
			$mail->Password   = 'hcez xucg ceif vxnv';                               //SMTP password
			$mail->SMTPSecure = 'tls';         //Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
			$mail->Port       = 587;                                    //TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

			//Recipients
			$mail->setFrom('lucascarregal123@gmail.com');
...
<html>
    ...
    <body>
        <div class="container">  
            ...
            <?php if($mensagem->status['cod_status'] == 2){ ?>
                
                <div class="conteiner">
                    <h1 class="display4 text-danger">Ops!</h1>
                    <p><?= $mensagem->status['descricao_status'] ?></p>
                    <a href="index.php" class="btn btn-success btn-lg mt-5 text-white">Voltar</a>
                </div>
